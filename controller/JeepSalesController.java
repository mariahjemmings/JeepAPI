...
@OpenAPIDefinition(info = @Info(title = "Jeep Sales Service"), servers = {@Server(url="http://localhost:8080", description = "LocalServer.")})
...
@Operation (
   ...
   parameters = {
       ...
       @Parameter(name = "model", allowEmptyValue = false, required = false, description = "The model name"),
       @Parameter(name = "trim", allowEmptyValue = false, required = false, description = "The trim name")
   }
